...
public class Principal extends javax.swing.JFrame {
    ...
    public void Ejecutar() throws Exception{
        ...
        if(numeroVariables==3)SR.variableNames = "W,X,Y,Z".split(",");
        if(numeroVariables==4)SR.variableNames = "V,W,X,Y,Z".split(",");
        if(numeroVariables==5)SR.variableNames = "U,V,W,X,Y,Z".split(",");
        if(numeroVariables==6)SR.variableNames = "T,U,V,W,X,Y,Z".split(",");
        if(numeroVariables==7)SR.variableNames = "S,T,U,V,W,X,Y,Z".split(",");
        if(numeroVariables==8)SR.variableNames = "R,S,T,U,V,W,X,Y,Z".split(",");
        if(numeroVariables==9)SR.variableNames = "Q,R,S,T,U,V,W,X,Y,Z".split(",");
        if(numeroVariables==10)SR.variableNames = "P,Q,R,S,T,U,V,W,X,Y,Z".split(",");
